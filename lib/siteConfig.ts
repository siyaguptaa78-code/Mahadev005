...
export const SITE_CONFIG = {
  ...
  url: "https://www.mahadevplayingid.com",
  description:
  ...
  keywords:
    "Mahadev Book, Mahadev Book ID, Mahadev Book Login, Mahadev Book Register, Buy Mahadev Book ID, Mahadev Playing ID",
  ogImage: "/images/mahadev-book-banner.webp",
  whatsappLink: "https://wa.me/916026703858",
  creator: "Mahadev Book",
  publisher: "Mahadev Book",
  googleVerification: "7UIjgfwPQCeuT5vdWov45xrt1q5l-pxjJHq3MhM2DiY",
};
